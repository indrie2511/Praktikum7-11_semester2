  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Praktikum Pemrograman Ke 11</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Form Dosen Update</h3>
  ...
  <div class="form-group row">
    <label for="pendidikan_akhir" class="col-4 col-form-label">Pendidikan</label> 
    <div class="col-8">
  ...
  <div class="form-group row">
    <label for="prodi_kode" class="col-4 col-form-label">Kode Program studi</label> 
    <div class="col-8">
