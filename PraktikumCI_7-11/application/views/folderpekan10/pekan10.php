        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url();?>index.php/mahasiswapekan10">Mahasiswa</a></li>
              <li class="breadcrumb-item"><a href="<?php echo base_url();?>index.php/pekan10">Dosen</a></li>
